...
abstract class AbstractTutoringSessionState {
    ...
    Per far sparire il warning SonarQube senza alterare la semantica possiamo pensare SOLO IN QUESTO CASO
    di silenziare i Warning attraverso l'annotazione @SuppressWarnings("unused")
    Quindi, per sintetizzare: silenziamo i Warning SonarQube in quanto i parametri stateMachine e tutoringSession
